	...
	<div id="length" style="margin-left:20px;width:<?php echo count($allConfidences)*7;?>px;">
		<?php
			foreach($allConfidences as $key => $scfd){
				echo '<a id="le-'.($key+1).'-'.$scfd[0].'-'.$scfd[1].'-'.$scfd[2].'-'.$scfd[3].'-'.$scfd[4].'-'.$scfd[6].'" href="?directory='.$dataDir.'&s='.($key+1).'" title="Sentence '.($key+1).' - Length '.$scfd[5].' symbols">
...
<div id="c1" class="row collapse">
	...
	<div id="confidence" style="margin-left:20px;width:<?php echo count($allConfidences)*7;?>px;">
		<?php
			foreach($allConfidences as $key => $scfd){
				echo '<a id="co-'.($key+1).'-'.$scfd[0].'-'.$scfd[1].'-'.$scfd[2].'-'.$scfd[3].'-'.$scfd[4].'-'.$scfd[6].'" href="?directory='.$dataDir.'&s='.($key+1).'" title="Sentence '.($key+1).' - Confidence '.$scfd[3].'%">
						<div class="progress progress-bar-vertical">
...
<div id="c2" class="row collapse">
	...
	<div id="cdp" style="margin-left:20px;width:<?php echo count($allConfidences)*7;?>px;">
		<?php
			foreach($allConfidences as $key => $scfd){
				echo '<a id="cd-'.($key+1).'-'.$scfd[0].'-'.$scfd[1].'-'.$scfd[2].'-'.$scfd[3].'-'.$scfd[4].'-'.$scfd[6].'" href="?directory='.$dataDir.'&s='.($key+1).'" title="Sentence '.($key+1).' - CDP '.$scfd[0].'%">
						<div class="progress progress-bar-vertical">
...
<div id="c3" class="row collapse">
	...
	<div id="apout" style="margin-left:20px;width:<?php echo count($allConfidences)*7;?>px;">
		<?php
			foreach($allConfidences as $key => $scfd){
				echo '<a id="ao-'.($key+1).'-'.$scfd[0].'-'.$scfd[1].'-'.$scfd[2].'-'.$scfd[3].'-'.$scfd[4].'-'.$scfd[6].'" href="?directory='.$dataDir.'&s='.($key+1).'" title="Sentence '.($key+1).' - APout '.$scfd[1].'%">
						<div class="progress progress-bar-vertical">
...
<div id="c4" class="row collapse">
	...
	<div id="apin" style="margin-left:20px;width:<?php echo count($allConfidences)*7;?>px;">
		<?php
			foreach($allConfidences as $key => $scfd){
				echo '<a id="ai-'.($key+1).'-'.$scfd[0].'-'.$scfd[1].'-'.$scfd[2].'-'.$scfd[3].'-'.$scfd[4].'-'.$scfd[6].'" href="?directory='.$dataDir.'&s='.($key+1).'" title="Sentence '.($key+1).' - APin '.$scfd[2].'%">
						<div class="progress progress-bar-vertical">
...
<div id="c6" class="row collapse">
	...
	<div id="bleu" style="margin-left:20px;width:<?php echo count($allConfidences)*7;?>px;">
		<?php
			foreach($allConfidences as $key => $scfd){
				echo '<a id="ab-'.($key+1).'-'.$scfd[0].'-'.$scfd[1].'-'.$scfd[2].'-'.$scfd[3].'-'.$scfd[4].'-'.$scfd[6].'" href="?directory='.$dataDir.'&s='.($key+1).'" title="Sentence '.($key+1).' - BLEU '.$scfd[6].'">
						<div class="progress progress-bar-vertical">
							<div id="bleu-'.($key+1).'" class="progress-bar progress-bar-purple" role="progressbar" aria-valuenow="'.$scfd[6].'" aria-valuemin="0" aria-valuemax="100" style="height: '.$scfd[6].'%;">
