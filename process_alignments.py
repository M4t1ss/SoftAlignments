                    ...
                    with open(folder + "/" + ntpath.basename(inputfile) + '.sc.js', 'w', encoding='utf-8') as out_sc_js:
                        ...
                        for i in range(0, len(data)):
                            ...
                            for ali_i in ali:
                                ...
                                if outputType != 'web':
                                    sys.stdout.write(src[word].encode(sys.stdout.encoding, errors='replace').decode('utf-8'))
                                word+=1
                                if outputType != 'web':
                                    sys.stdout.write('\n')
                            ...
                            if outputType != 'web':
                                for liline in outchars:
                                    sys.stdout.write(''.join(liline).encode(sys.stdout.encoding, errors='replace').decode('utf-8') + '\n')
                                # print scores
